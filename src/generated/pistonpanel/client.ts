...
export interface GlobalPermissionState {
    /**
     * @generated from protobuf field: pistonpanel.v1.GlobalPermission global_permission = 1;
     */
...
export interface ClientDataResponse {
    ...
    username: string;
    /**
     * @generated from protobuf field: pistonpanel.v1.UserRole role = 7;
     */
    role: UserRole;
    /**
    ...
    email: string;
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.GlobalPermissionState server_permissions = 2;
     */
    serverPermissions: GlobalPermissionState[];
    /**
     * @generated from protobuf field: pistonpanel.v1.ServerInfo server_info = 11;
     */
...
class GlobalPermissionState$Type extends MessageType<GlobalPermissionState> {
    constructor() {
        super("pistonpanel.v1.GlobalPermissionState", [
            { no: 1, name: "global_permission", kind: "enum", T: () => ["pistonpanel.v1.GlobalPermission", GlobalPermission] },
...
class ServerInfo$Type extends MessageType<ServerInfo> {
    constructor() {
        super("pistonpanel.v1.ServerInfo", [
...
class ClientDataResponse$Type extends MessageType<ClientDataResponse> {
    constructor() {
        super("pistonpanel.v1.ClientDataResponse", [
            { no: 6, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 1, name: "username", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 7, name: "role", kind: "enum", T: () => ["pistonpanel.v1.UserRole", UserRole] },
...
class GenerateWebDAVTokenResponse$Type extends MessageType<GenerateWebDAVTokenResponse> {
    constructor() {
        super("pistonpanel.v1.GenerateWebDAVTokenResponse", [
...
class GenerateAPITokenResponse$Type extends MessageType<GenerateAPITokenResponse> {
    constructor() {
        super("pistonpanel.v1.GenerateAPITokenResponse", [
            { no: 1, name: "token", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
}
...
class UpdateSelfUsernameRequest$Type extends MessageType<UpdateSelfUsernameRequest> {
    constructor() {
        super("pistonpanel.v1.UpdateSelfUsernameRequest", [
            { no: 1, name: "username", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
}
...
class UpdateSelfEmailRequest$Type extends MessageType<UpdateSelfEmailRequest> {
    constructor() {
        super("pistonpanel.v1.UpdateSelfEmailRequest", [
...
/**
 * @generated ServiceType for protobuf service pistonpanel.v1.ClientService
 */
export const ClientService = new ServiceType("pistonpanel.v1.ClientService", [
