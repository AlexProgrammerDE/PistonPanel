...
/**
 * @generated from protobuf message pistonpanel.v1.InstanceConfig
 */
export interface InstanceConfig {
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.SettingsNamespace settings = 1;
     */
    settings: SettingsNamespace[];
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.MinecraftAccountProto accounts = 2;
     */
    accounts: MinecraftAccountProto[];
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.ProxyProto proxies = 3;
     */
    proxies: ProxyProto[];
}
/**
...
export interface InstanceInfoResponse {
    ...
    icon: string;
    /**
     * @generated from protobuf field: pistonpanel.v1.InstanceConfig config = 2;
     */
    ...
    instancePermissions: InstancePermissionState[];
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.SettingsPage instance_settings = 6;
     */
...
/**
 * @generated from protobuf message pistonpanel.v1.InstanceUpdateConfigRequest
 */
...
/**
 * @generated from protobuf message pistonpanel.v1.InstanceUpdateConfigResponse
 */
...
class InstanceConfig$Type extends MessageType<InstanceConfig> {
    constructor() {
        super("pistonpanel.v1.InstanceConfig", [
...
/**
 * @generated MessageType for protobuf message pistonpanel.v1.InstanceConfig
 */
...
class InstanceListResponse_Instance$Type extends MessageType<InstanceListResponse_Instance> {
    constructor() {
        super("pistonpanel.v1.InstanceListResponse.Instance", [
            ...
            { no: 3, name: "state", kind: "enum", T: () => ["pistonpanel.v1.InstanceState", InstanceState] },
...
class InstancePermissionState$Type extends MessageType<InstancePermissionState> {
    constructor() {
        super("pistonpanel.v1.InstancePermissionState", [
            { no: 1, name: "instance_permission", kind: "enum", T: () => ["pistonpanel.v1.InstancePermission", InstancePermission] },
...
class InstanceUpdateConfigRequest$Type extends MessageType<InstanceUpdateConfigRequest> {
    constructor() {
        super("pistonpanel.v1.InstanceUpdateConfigRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "config", kind: "message", T: () => InstanceConfig }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message pistonpanel.v1.InstanceUpdateConfigRequest
 */
...
class InstanceUpdateConfigResponse$Type extends MessageType<InstanceUpdateConfigResponse> {
    constructor() {
        super("pistonpanel.v1.InstanceUpdateConfigResponse", []);
    }
}
/**
 * @generated MessageType for protobuf message pistonpanel.v1.InstanceUpdateConfigResponse
 */
...
class InstanceStateChangeRequest$Type extends MessageType<InstanceStateChangeRequest> {
    constructor() {
        super("pistonpanel.v1.InstanceStateChangeRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "state", kind: "enum", T: () => ["pistonpanel.v1.InstanceState", InstanceState] }
        ]);
    }
}
/**
...
class InstanceAuditLogResponse_AuditLogEntry$Type extends MessageType<InstanceAuditLogResponse_AuditLogEntry> {
    constructor() {
        super("pistonpanel.v1.InstanceAuditLogResponse.AuditLogEntry", [
            ...
            { no: 3, name: "type", kind: "enum", T: () => ["pistonpanel.v1.InstanceAuditLogResponse.AuditLogEntryType", InstanceAuditLogResponse_AuditLogEntryType] },
 ...
 */
export const InstanceService = new ServiceType("pistonpanel.v1.InstanceService", [
