...
export interface DownloadRequest {
    ...
    uri: string;
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.HeaderPair headers = 3;
     */
    headers: HeaderPair[];
    /**
     * @generated from protobuf field: optional pistonpanel.v1.ProxyProto proxy = 4;
     */
    proxy?: ProxyProto;
}
/**
...
export interface DownloadResponse {
    ...
    data: Uint8Array;
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.HeaderPair headers = 2;
     */
    headers: HeaderPair[];
    /**
...
class HeaderPair$Type extends MessageType<HeaderPair> {
    constructor() {
        super("pistonpanel.v1.HeaderPair", [
...
class DownloadRequest$Type extends MessageType<DownloadRequest> {
    constructor() {
        super("pistonpanel.v1.DownloadRequest", [
...
class DownloadResponse$Type extends MessageType<DownloadResponse> {
    constructor() {
        super("pistonpanel.v1.DownloadResponse", [
...
/**
 * @generated ServiceType for protobuf service pistonpanel.v1.DownloadService
 */
export const DownloadService = new ServiceType("pistonpanel.v1.DownloadService", [
