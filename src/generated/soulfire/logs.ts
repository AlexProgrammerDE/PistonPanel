...
export interface LogScope {
    ...
    scope: {
        oneofKind: "global";
        /**
         * @generated from protobuf field: pistonpanel.v1.GlobalLogScope global = 1;
         */
        global: GlobalLogScope;
    } | {
        oneofKind: "instance";
        /**
         * @generated from protobuf field: pistonpanel.v1.InstanceLogScope instance = 2;
         */
        instance: InstanceLogScope;
    } | {
        oneofKind: "bot";
        /**
         * @generated from protobuf field: pistonpanel.v1.BotLogScope bot = 3;
         */
        bot: BotLogScope;
    } | {
        oneofKind: "globalScript";
        /**
         * @generated from protobuf field: pistonpanel.v1.GlobalScriptLogScope global_script = 4;
         */
        globalScript: GlobalScriptLogScope;
    } | {
        oneofKind: "instanceScript";
        /**
         * @generated from protobuf field: pistonpanel.v1.InstanceScriptLogScope instance_script = 5;
         */
...
export interface PreviousLogRequest {
    /**
     * @generated from protobuf field: pistonpanel.v1.LogScope scope = 4;
     */
    scope?: LogScope;
    /**
...
export interface PreviousLogResponse {
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.LogString messages = 1;
     */
    messages: LogString[];
}
/**
...
export interface LogRequest {
    /**
     * @generated from protobuf field: pistonpanel.v1.LogScope scope = 3;
     */
    scope?: LogScope;
}
/**
...
export interface LogResponse {
    /**
     * @generated from protobuf field: pistonpanel.v1.LogString message = 1;
     */
    message?: LogString;
}
...
class LogString$Type extends MessageType<LogString> {
    constructor() {
        super("pistonpanel.v1.LogString", [
...
class InstanceLogScope$Type extends MessageType<InstanceLogScope> {
    constructor() {
        super("pistonpanel.v1.InstanceLogScope", [
...
class BotLogScope$Type extends MessageType<BotLogScope> {
    constructor() {
        super("pistonpanel.v1.BotLogScope", [
            { no: 1, name: "instance_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class GlobalScriptLogScope$Type extends MessageType<GlobalScriptLogScope> {
    constructor() {
        super("pistonpanel.v1.GlobalScriptLogScope", [
...
class InstanceScriptLogScope$Type extends MessageType<InstanceScriptLogScope> {
    constructor() {
        super("pistonpanel.v1.InstanceScriptLogScope", [
            { no: 1, name: "instance_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class PreviousLogRequest$Type extends MessageType<PreviousLogRequest> {
    constructor() {
        super("pistonpanel.v1.PreviousLogRequest", [
...
class PreviousLogResponse$Type extends MessageType<PreviousLogResponse> {
    constructor() {
        super("pistonpanel.v1.PreviousLogResponse", [
...
class LogRequest$Type extends MessageType<LogRequest> {
    constructor() {
        super("pistonpanel.v1.LogRequest", [
...
class LogResponse$Type extends MessageType<LogResponse> {
    constructor() {
        super("pistonpanel.v1.LogResponse", [
...
/**
 * @generated ServiceType for protobuf service pistonpanel.v1.LogsService
 */
export const LogsService = new ServiceType("pistonpanel.v1.LogsService", [
