...
// @generated from protobuf file "pistonpanel/mc-auth.proto" (package "pistonpanel.v1", syntax proto3)
// tslint:disable
// @ts-nocheck
...
/**
 * @generated from protobuf message pistonpanel.v1.CredentialsAuthRequest
 */
export interface CredentialsAuthRequest {
    ...
    instanceId: string;
    /**
     * @generated from protobuf field: pistonpanel.v1.AccountTypeCredentials service = 2;
     */
 ...
 *
 * @generated from protobuf message pistonpanel.v1.CredentialsAuthFullList
 */
export interface CredentialsAuthFullList {
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.MinecraftAccountProto account = 1;
     */
 ...
 *
 * @generated from protobuf message pistonpanel.v1.CredentialsAuthOneSuccess
 */
 ...
 *
 * @generated from protobuf message pistonpanel.v1.CredentialsAuthOneFailure
 */
export interface CredentialsAuthOneFailure {
}
/**
 * @generated from protobuf message pistonpanel.v1.CredentialsAuthResponse
 */
export interface CredentialsAuthResponse {
    ...
    data: {
        oneofKind: "fullList";
        /**
         * @generated from protobuf field: pistonpanel.v1.CredentialsAuthFullList full_list = 1;
         */
        fullList: CredentialsAuthFullList;
    } | {
        oneofKind: "oneSuccess";
        /**
         * @generated from protobuf field: pistonpanel.v1.CredentialsAuthOneSuccess one_success = 2;
         */
        oneSuccess: CredentialsAuthOneSuccess;
    } | {
        oneofKind: "oneFailure";
        /**
         * @generated from protobuf field: pistonpanel.v1.CredentialsAuthOneFailure one_failure = 3;
         */
...
/**
 * @generated from protobuf message pistonpanel.v1.DeviceCodeAuthRequest
 */
export interface DeviceCodeAuthRequest {
    ...
    instanceId: string;
    /**
     * @generated from protobuf field: pistonpanel.v1.AccountTypeDeviceCode service = 2;
     */
    service: AccountTypeDeviceCode;
}
/**
 * @generated from protobuf message pistonpanel.v1.DeviceCode
 */
...
/**
 * @generated from protobuf message pistonpanel.v1.DeviceCodeAuthResponse
 */
export interface DeviceCodeAuthResponse {
    ...
    data: {
        oneofKind: "account";
        /**
         * @generated from protobuf field: pistonpanel.v1.MinecraftAccountProto account = 1;
         */
        account: MinecraftAccountProto;
    } | {
        oneofKind: "deviceCode";
        /**
         * @generated from protobuf field: pistonpanel.v1.DeviceCode device_code = 2;
         */
...
/**
 * @generated from protobuf message pistonpanel.v1.RefreshRequest
 */
export interface RefreshRequest {
    ...
    instanceId: string;
    /**
     * @generated from protobuf field: pistonpanel.v1.MinecraftAccountProto account = 2;
     */
    account?: MinecraftAccountProto;
}
/**
 * @generated from protobuf message pistonpanel.v1.RefreshResponse
 */
...
class CredentialsAuthRequest$Type extends MessageType<CredentialsAuthRequest> {
    constructor() {
        super("pistonpanel.v1.CredentialsAuthRequest", [
            { no: 1, name: "instance_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "service", kind: "enum", T: () => ["pistonpanel.v1.AccountTypeCredentials", AccountTypeCredentials] },
            { no: 3, name: "payload", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message pistonpanel.v1.CredentialsAuthRequest
 */
...
class CredentialsAuthFullList$Type extends MessageType<CredentialsAuthFullList> {
    constructor() {
        super("pistonpanel.v1.CredentialsAuthFullList", [
            { no: 1, name: "account", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MinecraftAccountProto }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message pistonpanel.v1.CredentialsAuthFullList
 */
...
class CredentialsAuthOneSuccess$Type extends MessageType<CredentialsAuthOneSuccess> {
    constructor() {
        super("pistonpanel.v1.CredentialsAuthOneSuccess", []);
    }
}
/**
 * @generated MessageType for protobuf message pistonpanel.v1.CredentialsAuthOneSuccess
 */
...
class CredentialsAuthOneFailure$Type extends MessageType<CredentialsAuthOneFailure> {
    constructor() {
        super("pistonpanel.v1.CredentialsAuthOneFailure", []);
    }
}
/**
 * @generated MessageType for protobuf message pistonpanel.v1.CredentialsAuthOneFailure
 */
...
class CredentialsAuthResponse$Type extends MessageType<CredentialsAuthResponse> {
    constructor() {
        super("pistonpanel.v1.CredentialsAuthResponse", [
...
/**
 * @generated MessageType for protobuf message pistonpanel.v1.CredentialsAuthResponse
 */
...
class DeviceCodeAuthRequest$Type extends MessageType<DeviceCodeAuthRequest> {
    constructor() {
        super("pistonpanel.v1.DeviceCodeAuthRequest", [
            { no: 1, name: "instance_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "service", kind: "enum", T: () => ["pistonpanel.v1.AccountTypeDeviceCode", AccountTypeDeviceCode] }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message pistonpanel.v1.DeviceCodeAuthRequest
 */
export const DeviceCodeAuthRequest = new DeviceCodeAuthRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DeviceCode$Type extends MessageType<DeviceCode> {
    constructor() {
        super("pistonpanel.v1.DeviceCode", [
...
/**
 * @generated MessageType for protobuf message pistonpanel.v1.DeviceCodeAuthResponse
 */
...
class RefreshRequest$Type extends MessageType<RefreshRequest> {
    constructor() {
        super("pistonpanel.v1.RefreshRequest", [
            { no: 1, name: "instance_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message pistonpanel.v1.RefreshRequest
 */
export const RefreshRequest = new RefreshRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RefreshResponse$Type extends MessageType<RefreshResponse> {
    constructor() {
        super("pistonpanel.v1.RefreshResponse", [
            { no: 1, name: "account", kind: "message", T: () => MinecraftAccountProto }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message pistonpanel.v1.RefreshResponse
 */
export const RefreshResponse = new RefreshResponse$Type();
/**
 * @generated ServiceType for protobuf service pistonpanel.v1.MCAuthService
 */
export const MCAuthService = new ServiceType("pistonpanel.v1.MCAuthService", [
