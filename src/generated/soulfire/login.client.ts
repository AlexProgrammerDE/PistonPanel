...
/**
 * @generated from protobuf service pistonpanel.v1.LoginService
 */
export interface ILoginServiceClient {
    /**
     * @generated from protobuf rpc: Login(pistonpanel.v1.LoginRequest) returns (pistonpanel.v1.NextAuthFlowResponse);
     */
    login(input: LoginRequest, options?: RpcOptions): UnaryCall<LoginRequest, NextAuthFlowResponse>;
    /**
     * @generated from protobuf rpc: EmailCode(pistonpanel.v1.EmailCodeRequest) returns (pistonpanel.v1.NextAuthFlowResponse);
     */
