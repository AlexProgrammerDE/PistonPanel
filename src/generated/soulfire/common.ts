...
// @generated from protobuf file "pistonpanel/common.proto" (package "pistonpanel.v1", syntax proto3)
// tslint:disable
// @ts-nocheck
...
export interface ProxyProto {
    /**
     * @generated from protobuf field: pistonpanel.v1.ProxyProto.Type type = 1;
     */
...
export interface MinecraftAccountProto {
    /**
     * @generated from protobuf field: pistonpanel.v1.MinecraftAccountProto.AccountTypeProto type = 1;
     */
    ...
    accountData: {
        ...
        /**
         * @generated from protobuf field: pistonpanel.v1.MinecraftAccountProto.OnlineChainJavaData online_chain_java_data = 5;
         */
        onlineChainJavaData: MinecraftAccountProto_OnlineChainJavaData;
    } | {
        oneofKind: "offlineJavaData";
        /**
         * @generated from protobuf field: pistonpanel.v1.MinecraftAccountProto.OfflineJavaData offline_java_data = 6;
         */
        offlineJavaData: MinecraftAccountProto_OfflineJavaData;
    } | {
        oneofKind: "bedrockData";
        /**
         * @generated from protobuf field: pistonpanel.v1.MinecraftAccountProto.BedrockData bedrock_data = 7;
         */
...
export interface SettingsNamespace {
    ...
    namespace: string;
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.SettingsEntry entries = 2;
     */
...
export interface StringSetting {
    ...
    def: string;
    /**
     * @generated from protobuf field: pistonpanel.v1.StringSetting.InputType input_type = 10;
     */
...
export interface ComboSetting {
     ...
     * List of options
     *
     * @generated from protobuf field: repeated pistonpanel.v1.ComboSetting.Option options = 3;
     */
...
export interface MinMaxSetting {
    ...
    thousandSeparator: boolean;
    /**
     * @generated from protobuf field: pistonpanel.v1.MinMaxSetting.Entry minEntry = 5;
     */
    minEntry?: MinMaxSetting_Entry;
    /**
     * @generated from protobuf field: pistonpanel.v1.MinMaxSetting.Entry maxEntry = 6;
     */
 ...
 *
 * @generated from protobuf message pistonpanel.v1.SettingEntry
 */
export interface SettingEntry {
    ...
    value: {
        oneofKind: "string";
        /**
         * @generated from protobuf field: pistonpanel.v1.StringSetting string = 2;
         */
        string: StringSetting;
    } | {
        oneofKind: "int";
        /**
         * @generated from protobuf field: pistonpanel.v1.IntSetting int = 3;
         */
        int: IntSetting;
    } | {
        oneofKind: "double";
        /**
         * @generated from protobuf field: pistonpanel.v1.DoubleSetting double = 4;
         */
        double: DoubleSetting;
    } | {
        oneofKind: "bool";
        /**
         * @generated from protobuf field: pistonpanel.v1.BoolSetting bool = 5;
         */
        bool: BoolSetting;
    } | {
        oneofKind: "combo";
        /**
         * @generated from protobuf field: pistonpanel.v1.ComboSetting combo = 6;
         */
        combo: ComboSetting;
    } | {
        oneofKind: "stringList";
        /**
         * @generated from protobuf field: pistonpanel.v1.StringListSetting string_list = 7;
         */
        stringList: StringListSetting;
    } | {
        oneofKind: "minMax";
        /**
         * @generated from protobuf field: pistonpanel.v1.MinMaxSetting min_max = 8;
         */
...
export interface SettingsPage {
    /**
     * @generated from protobuf field: optional pistonpanel.v1.ServerPlugin owning_plugin = 2;
     */
    ...
    namespace: string;
    /**
     * @generated from protobuf field: repeated pistonpanel.v1.SettingEntry entries = 5;
     */
...
class ProxyProto$Type extends MessageType<ProxyProto> {
    constructor() {
        super("pistonpanel.v1.ProxyProto", [
            { no: 1, name: "type", kind: "enum", T: () => ["pistonpanel.v1.ProxyProto.Type", ProxyProto_Type] },
...
class MinecraftAccountProto$Type extends MessageType<MinecraftAccountProto> {
    constructor() {
        super("pistonpanel.v1.MinecraftAccountProto", [
            { no: 1, name: "type", kind: "enum", T: () => ["pistonpanel.v1.MinecraftAccountProto.AccountTypeProto", MinecraftAccountProto_AccountTypeProto] },
...
class MinecraftAccountProto_OnlineChainJavaData$Type extends MessageType<MinecraftAccountProto_OnlineChainJavaData> {
    constructor() {
        super("pistonpanel.v1.MinecraftAccountProto.OnlineChainJavaData", [
...
class MinecraftAccountProto_BedrockData$Type extends MessageType<MinecraftAccountProto_BedrockData> {
    constructor() {
        super("pistonpanel.v1.MinecraftAccountProto.BedrockData", [
...
class SettingsEntry$Type extends MessageType<SettingsEntry> {
    constructor() {
        super("pistonpanel.v1.SettingsEntry", [
...
class SettingsNamespace$Type extends MessageType<SettingsNamespace> {
    constructor() {
        super("pistonpanel.v1.SettingsNamespace", [
...
class StringSetting$Type extends MessageType<StringSetting> {
    constructor() {
        super("pistonpanel.v1.StringSetting", [
            { no: 1, name: "ui_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "def", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 10, name: "input_type", kind: "enum", T: () => ["pistonpanel.v1.StringSetting.InputType", StringSetting_InputType] },
...
class IntSetting$Type extends MessageType<IntSetting> {
    constructor() {
        super("pistonpanel.v1.IntSetting", [
            { no: 1, name: "ui_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class DoubleSetting$Type extends MessageType<DoubleSetting> {
    constructor() {
        super("pistonpanel.v1.DoubleSetting", [
            { no: 1, name: "ui_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class BoolSetting$Type extends MessageType<BoolSetting> {
    constructor() {
        super("pistonpanel.v1.BoolSetting", [
            { no: 1, name: "ui_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class ComboSetting$Type extends MessageType<ComboSetting> {
    constructor() {
        super("pistonpanel.v1.ComboSetting", [
            { no: 1, name: "ui_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class ComboSetting_Option$Type extends MessageType<ComboSetting_Option> {
    constructor() {
        super("pistonpanel.v1.ComboSetting.Option", [
...
class StringListSetting$Type extends MessageType<StringListSetting> {
    constructor() {
        super("pistonpanel.v1.StringListSetting", [
            { no: 1, name: "ui_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class MinMaxSetting$Type extends MessageType<MinMaxSetting> {
    constructor() {
        super("pistonpanel.v1.MinMaxSetting", [
...
class MinMaxSetting_Entry$Type extends MessageType<MinMaxSetting_Entry> {
    constructor() {
        super("pistonpanel.v1.MinMaxSetting.Entry", [
            { no: 1, name: "ui_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "def", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
...
class SettingEntry$Type extends MessageType<SettingEntry> {
    constructor() {
        super("pistonpanel.v1.SettingEntry", [
            { no: 1, name: "key", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class SettingsPage$Type extends MessageType<SettingsPage> {
    constructor() {
        super("pistonpanel.v1.SettingsPage", [
...
class ServerPlugin$Type extends MessageType<ServerPlugin> {
    constructor() {
        super("pistonpanel.v1.ServerPlugin", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
