...
/**
 * @generated from protobuf service pistonpanel.v1.UserService
 */
export interface IUserServiceClient {
  /**
   * @generated from protobuf rpc: CreateUser(pistonpanel.v1.UserCreateRequest) returns (pistonpanel.v1.UserCreateResponse);
   */
  createUser(
  ...
  /**
   * @generated from protobuf rpc: DeleteUser(pistonpanel.v1.UserDeleteRequest) returns (pistonpanel.v1.UserDeleteResponse);
   */
  deleteUser(
  ...
  /**
   * @generated from protobuf rpc: ListUsers(pistonpanel.v1.UserListRequest) returns (pistonpanel.v1.UserListResponse);
   */
  listUsers(
  ...
  /**
   * @generated from protobuf rpc: GetUserInfo(pistonpanel.v1.UserInfoRequest) returns (pistonpanel.v1.UserInfoResponse);
   */
  getUserInfo(
  ...
  /**
   * @generated from protobuf rpc: InvalidateSessions(pistonpanel.v1.InvalidateSessionsRequest) returns (pistonpanel.v1.InvalidateSessionsResponse);
   */
  invalidateSessions(
  ...
  /**
   * @generated from protobuf rpc: UpdateUser(pistonpanel.v1.UpdateUserRequest) returns (pistonpanel.v1.UpdateUserResponse);
   */
  updateUser(
  ...
  /**
   * @generated from protobuf rpc: GenerateUserAPIToken(pistonpanel.v1.GenerateUserAPITokenRequest) returns (pistonpanel.v1.GenerateUserAPITokenResponse);
   */
